...
class StockCriticoController extends Controller
{
    ...
    return view('StockCritico\StockCritico.StockDesaparecido', compact('datos'));
    }
    ...
    public function StockNecesario(){
        ...
        ->get();
        return view('StockCritico\StockCritico.StockNecesario',compact('datos','familia','comentario','estado'));
    }
    ...
    public function StockGuardado(){
        ...
        ->get();
        return view('StockCritico\StockCritico.StockGuardado',compact('datos','familia','comentario','status','listado'));
    }
